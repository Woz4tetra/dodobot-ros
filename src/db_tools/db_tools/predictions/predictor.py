import numpy as np
from db_tools.state.simplepose3d import SimplePose3d
...
class BouncePredictor:
    ...
    def update_buffers(self, obj_state: SimplePose3d, odom_state: SimplePose3d):
    ...
    def get_robot_intersection(self, obj_state: SimplePose3d, odom_state: SimplePose3d):
        ...
        future_obj_state = SimplePose3d.from_state(self.obj_buffer[-1])
