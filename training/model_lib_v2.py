...
def train_loop(**kwargs):
  ...
  save_final_config = kwargs.get("save_final_config", False)
  checkpoint_every_n = kwargs.get("checkpoint_every_n", 1000)
  checkpoint_max_to_keep = kwargs.get("checkpoint_max_to_keep", 7)
  record_summaries = kwargs.get("record_summaries", True)
  performance_summary_exporter = kwargs.get("performance_summary_exporter", None)
  num_steps_per_iteration = kwargs.get("num_steps_per_iteration", NUM_STEPS_PER_ITERATION)
  
  tf.logging.info("Training arguments: %s" % str(kwargs))
